		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_required':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> پرکردن آن اجباری است.";
					break;
				case 'validate_valid_email':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید یک آدرس ایمیل معتبر باشد.";
					break;
				case 'validate_max_len':
					if($param == 1) {
						$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید کوچکتر از $param کاراکتر باشد.";
					} else {
						$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید کوچکتر از $param کاراکتر باشد.";
					}
					break;
				case 'validate_min_len':
					if($param == 1) {
						$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید بزرگتر از $param کاراکتر باشد.";
					} else {
						$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید بزرگتر از $param کاراکتر باشد.";
					}
					break;
				case 'validate_exact_len':
					if($param == 1) {
						$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید دقیقا به اندازه $param کاراکتر طول داشته باشد.";
					} else {
						$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید دقیقا به اندازه $param کاراکتر طول داشته باشد.";
					}
					break;
				case 'validate_alpha':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید فقط حاوی حروف الفبا باشد.";
					break;
				case 'validate_alpha_numeric':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید فقط حاوی حروف الفبا و اعداد باشد.";
					break;
				case 'validate_alpha_dash':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید فقط حاوی حروف الفبا و اعداد و کاراکتر &amp; باشد.";
					break;
				case 'validate_numeric':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> فقط باید عددی باشد.";
					break;
				case 'validate_integer':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید از نوع عددصحیح باشد.";
					break;
				case 'validate_boolean':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید از نوع  boolean باشد.";
					break;
				case 'validate_float':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید فقط از نوع اعشاری باشد.";
					break;
				case 'validate_valid_url':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید یک آدرس URL معتبر باشد.";
					break;
				case 'validate_url_exists':
					$resp[] = "آدرس <span class=\"$field_class\">$field</span> URL موجود نیست.";
					break;
				case 'validate_valid_ip':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید حاوی یک آدرس IP معتبر باشد.";
					break;
				case 'validate_valid_cc':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید حاوی شماره و کارت اعتباری معتبر باشد.";
					break;
				case 'validate_valid_name':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید نام یک انسان باشد.";
					break;
				case 'validate_contains':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید یکی از این مقادیر باشد: ".implode(', ', $param).'.';
					break;
				case 'validate_street_address':
					$resp[] = "The <span class=\"$field_class\">$field</span> field needs to be a valid street address";
					break;
				case 'validate_date':
					$resp[] = "فیلد <span class=\"$field_class\">$field</span> باید فرمت تاریخ باشد.";
					break;
